...
exports.detectExcessiveSpacing = detectExcessiveSpacing;
exports.reconstructSpacedText = reconstructSpacedText;
/**
 ...
 */
function detectExcessiveSpacing(text) {
 ...
 */
function reconstructSpacedText(text) {
